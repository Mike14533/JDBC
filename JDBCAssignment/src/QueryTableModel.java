...
class QueryTableModel extends AbstractTableModel
{
	...
	public void refreshFromDB( Statement stmt1)
	{
		...
		try{	
			...
			//rs = stmt.executeQuery("SELECT customer.id, customer.firstName as First_Name, customer.lastName as Last_Name, customer.emailAddress as Email, customer.Address as Address, customer.phoneNumber as Phone_Number, dog.dogName as Dogs_Name, dog.size as Dogs_Size, dog.breed as Dogs_Breed " +
	            //   "FROM customer INNER JOIN dog ON customer.id = dog.id");
